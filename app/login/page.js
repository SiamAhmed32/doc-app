...
const BrandingPanel = () => (
  ...
  >
    ...
    <div>
      ...
      >
        Welcome Back to Simplified Doctor Appointment System
      </motion.h1>
      <motion.p variants={itemVariants} className="mt-4 text-slate-300">
        Manage your appointments, connect with specialists, and take control of
        your health journey.
      </motion.p>
    </div>
    <motion.div variants={itemVariants} className="space-y-4">
      <div className="flex items-center gap-3">
        ...
        <span>Find top-rated specialists in minutes.</span>
      </div>
      <div className="flex items-center gap-3">
        <CheckIcon className="h-6 w-6 text-sky-400 flex-shrink-0" />
        <span>Book and manage appointments 24/7.</span>
      </div>
      <div className="flex items-center gap-3">
        <CheckIcon className="h-6 w-6 text-sky-400 flex-shrink-0" />
