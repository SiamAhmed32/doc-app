  ...
  return (
    <Modal isOpen={!!doctor} onClose={onClose} title={doctor.name}>
      <div className="flex flex-col items-center text-center">
        ...
        <p className="mt-2 text-lg font-medium text-sky-600 dark:text-sky-400">
          {doctor.specialization}
        </p>
        <div className="mt-4 w-full space-y-2 border-t pt-4 text-left text-sm text-slate-600 dark:border-slate-700 dark:text-slate-300">
          <p>
